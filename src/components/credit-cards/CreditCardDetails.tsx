...
export default function CreditCardDetails() {
  ...
  const fetchTransactions = async () => {
    ...
    const result = await apiGetCreditCardTransactions(
      token,
        ...
        <Stack spacing={2} sx={{ mt: '4em', mx: '1em', color: '#5E548E' }}>
          <Box
            sx={{
              ...
              pb: '1em',
              borderBottom: '1px solid #E0B1CB',
            }}
          >
            <Typography>CARD NUMBER:</Typography>
            <Typography sx={{ ml: '1em' }}>
              {' '}
              {formatNum(currentCreditCard.cardNumber)}{' '}
            </Typography>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            <Typography>
              {' '}
              {formatDate(currentCreditCard.expirationDate)}{' '}
            </Typography>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            <Typography>
              ...
              {priceFormatter.format(
                currentCreditCard.totalLimit -
                  currentCreditCard.availableBalance
              )}{' '}
            </Typography>
          </Box>
          <Box
          ...
          >
            ...
            <Typography>
              {' '}
              {priceFormatter.format(currentCreditCard.totalLimit)}{' '}
            </Typography>
          </Box>
